...
def compute():
    ...
    y_stationary = np.matmul(s0, np.linalg.inv(infinitesimal_generator_prime))
    ...
    print("Throughput: %f" % (y[999999][6]*1*(infinitesimal_generator[6][0] +
        infinitesimal_generator[6][1]) + y[999999][2]*1*(infinitesimal_generator[2][0] +
        infinitesimal_generator[2][1]) + y[999999][3]*1*(infinitesimal_generator[3][0] +
